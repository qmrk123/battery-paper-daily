...
TOPIC_IDS = ["li-metal", "na-metal", "na-cathode", "ncm", "li-rich", "lfp", "other-cathode"]

SYSTEM = (
    "당신은 이차전지(배터리) 소재 연구자를 돕는 조수입니다. 주어진 논문의 제목·초록과 "
    "'배정 후보 주제'를 보고 두 가지를 출력합니다.\n"
    "1) 분류(topics): 이 논문이 실제로 다루는 주제를 아래 7가지 중 모두 고르세요(복수 가능). "
    ...
    "  [리튬 양극(cathode) — 아래 넷 중 정확히 골라 배정]\n"
    ...
    "  [소듐 양극(cathode)]\n"
    "   - na-cathode: 소듐(Na-ion) 양극재 — Na 층상 산화물(P2/O3형), 폴리음이온(Na3V2(PO4)3/NASICON, "
    "인산염·황산염·불화인산염), 프러시안블루 유사체(PBA) 등 Na-ion 전지의 양극\n"
    "   ★ 음극/양극을 혼동하지 마세요(anode-free lithium=li-metal). Na-ion 양극재는 na-cathode. "
    "순수 물리/촉매·물분해·연료전지, Si/흑연·하드카본 음극, 전해질만 다루는 연구 등 위 7개에 안 "
    "맞으면 빈 배열([]).\n"
